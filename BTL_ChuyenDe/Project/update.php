...
<input type="text" name='idsp' class='giohang' placeholder="Nhập id sản phẩm"><br>
<input type="text" name="sanphamupdate" class='giohang'placeholder="Nhập tên sản phẩm"><br>
<input type="text" name="diachi" class='giohang' placeholder="Nhập địa chỉ"><br>
<input type='submit' value='Sửa sản phẩm' name='update' class='giohang'><br>
<div class='middle'>
<?php
ob_start();
require 'link.php';
...
if(isset($_POST['update'])){
    ...
    $tensp = $_POST ["sanphamupdate"] ; 
    $diachi = $_POST  ["diachi"] ;
    foreach ($chkarr as $id_san_pham) {
        $sql= "UPDATE trangnpham SET id_san_pham='$idsp' , ten_san_pham ='$tensp' , dia_chi ='$diachi' Where id_san_pham='$id_san_pham' ";
        $conn->query($sql);
